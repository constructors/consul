...
describe "Legislation" do
  ...
  context "empty process" do
    let(:process) do
      create(:legislation_process, :empty, result_publication_enabled: true, end_date: Date.current - 1.day)
    end

    scenario "empty warning" do
